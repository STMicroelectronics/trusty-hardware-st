...
struct __unaligned_u16_t { uint16_t x; } __attribute__((__packed__));
struct __unaligned_u32_t { uint32_t x; } __attribute__((__packed__));
struct __unaligned_u64_t { uint64_t x; } __attribute__((__packed__));
